...
{{--                        </a>--}}
{{--                    </div>--}}
                    <a href="#submenu1" data-toggle="collapse" aria-expanded="{{ $leave ?? false }}" class="bg-dark list-group-item list-group-item-action flex-column align-items-start {{ isset($leave) ? '' : 'collapsed' }}">
                        <div class="d-flex w-100 justify-content-start align-items-center">
                    ...
                    <!-- Submenu content -->
                    <div id='submenu1' class="collapse sidebar-submenu {{ isset($leave) ? 'show' : '' }}">
                    ...
                    <a href="#submenu2" data-toggle="collapse" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                        <div class="d-flex w-100 justify-content-start align-items-center">
