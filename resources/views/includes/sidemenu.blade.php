@section('sidemenu')
    ...
    <div id="sidebar-container" class="hide-mobile sidebar-expanded d-none d-md-block">
        ...
        <!-- /END Separator -->
            ...
            <!-- Submenu content -->
            <div id='submenu0' class="collapse sidebar-submenu {{ isset($users) ? 'show' : '' }}">
                <a href="{{ route('emp-registration-att-edit') }}" class="list-group-item list-group-item-action bg-dark text-white">
            ...
            <a href="#submenu1" data-toggle="collapse" aria-expanded="{{ $leave ?? false }}"
